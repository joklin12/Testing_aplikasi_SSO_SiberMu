...
$client_login_page = 'http://localhost/sso_tester_noindex/callback.php'; // GANTI SESUAI URL ANDA (arahkan ke login.php setelah logout)
    ...
    <div class="container mt-5">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
				...
				// Halaman login aplikasi ini, tempat pengguna akan kembali setelah logout
				$client_login_page = 'http://localhost/sso_tester_noindex/logout.php'; // GANTI SESUAI URL ANDA
