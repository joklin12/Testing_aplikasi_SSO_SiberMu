...
if ($http_code === 200 && isset($data['success']) && $data['success']) {
    ...
    // --- PENGECEKAN ORGANISASI ---
    // Ganti dengan nama organisasi yang Anda izinkan.
    $allowed = 'SMA 1 TESTING'; 

    if (isset($user_data['institusi']) && $user_data['institusi'] === $allowed) {
        // institusi/Organisasi sesuai, simpan data user ke session dan lanjutkan.
