...
$api_url = 'https://sso.sibermu.ac.id/api_create_user.php'; //url server sso sibermu pastikan saat diakses langsung muncul {"success":false,"error":"Metode tidak diizinkan. Gunakan POST."} menandakan sudah aktif siap terima data dari aplikasi anda
