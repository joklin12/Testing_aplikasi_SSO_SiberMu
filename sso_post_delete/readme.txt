...
Konfigurasi awal
-Menentukan URL API SSO ($api_url), yaitu alamat server tujuan yaitu : https://sso.sibermu.ac.id/api_delete_user.php dan pastikan saat diakses langsung muncul {"success":false,"error":"Metode tidak diizinkan. Gunakan POST."} menandakan sudah aktif siap terima data dari aplikasi anda
